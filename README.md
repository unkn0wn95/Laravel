...
# 3 Method to view our laravel website in localhost

## Method 1 : Through Xampp itself

Go to localhost/[yourFilename]/public

## Method 2 : Through php artisan server

- Go to the htdocs file and open [yourfilename] 
- And then open terminal on that file and run ``` php artisan serve ```

## Method 3 : Virtual Host Setup
